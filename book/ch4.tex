...
It is based on a collection of connected units or nodes, which loosely model the neurons in a biological brain. Each connection, like the synapses in a biological brain, can transmit a signal to other neurons. An artificial neuron that receives a signal then processes it and can signal neurons connected to it.
\begin{figure}[H]
                \centering
...
The model of the processing unit is the \textbf{Rosenblatt's perceptron}. 
...
\subsection{Perceptron: the structural computing unit for regressions and classifications}
...
\subsection{Behind backpropagation: Computational Graphs}
...
\subsection{Summary for layer and data size}
