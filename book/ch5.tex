     \chapter{Advanced Deep Learning Architectures}
            This chapter will be introduced with some considerations on how to handle data. 
...
\subsection{LeNet AND AlexNet}
These are the \textbf{convolutional neural} \textbf{networks} that marked a \textbf{break} from the technologies considered state of the art at the time.
\noindent
